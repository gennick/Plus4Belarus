...
- (id)initWithFrame:(struct CGRect)arg1 recentCall:(id)arg2 occurrenceDate:(id)arg3 type:(int)arg4 duration:(double)arg5 category:(int)arg6 dataUsage:(double)arg7;
